...
#+begin_src emacs-lisp
  (zb init-yasnippet
    ...
    ;; Enable yasnippet in certain modes.
    (setq zy-yas-hook-list '(latex-mode-hook))
    (defun zy-enable-yas-minor-mode () (yas-minor-mode +1))
    (dolist (hook zy-yas-hook-list)
      (add-hook hook #'zy-enable-yas-minor-mode))
    ;; Snippet shortcut.
    (general-define-key
