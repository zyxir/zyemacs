...
Adjust UI elements to make a prose-writing environment.
...
#+begin_src emacs-lisp
  ...
  (defvar zy/prose nil
    "If prose writing features is active.")
  (defun zy/prose ()
    "Enable or disable prose writing features."
    (interactive)
    (if zy/prose
        (progn
          (zy/set-font zy/fonts-default)
          (setq zy/prose nil))
      (zy/set-font zy/fonts-prose)
      (setq zy/prose t)))
#+end_src
